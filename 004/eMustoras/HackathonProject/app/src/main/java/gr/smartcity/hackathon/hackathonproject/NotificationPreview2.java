 ...
 */
public class NotificationPreview2 extends AsyncTask<Void, Void, Void> {
    ...
    public NotificationPreview2(String id1, NotificationManager manager, Resources resources, Context context) {
        this.id1 = id1;
    ...
    protected Void doInBackground(Void... voids) {
        ...
        synchronized (DatabaseConnection.con) {
            try {
                String exploration_query = "select count(distinct custid) from public_pending where wid like '" + id1 + "'";
